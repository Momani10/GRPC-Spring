...
import ma.projet.grpc.repo.CompteRepository;
...
public class CompteServiceImpl extends CompteServiceGrpc.CompteServiceImplBase {
    ...
    @Override
    public <DeleteCompteRequest, DeleteCompteResponse> void deleteCompte(DeleteCompteRequest request, StreamObserver<DeleteCompteResponse> responseObserver) {
        try {
